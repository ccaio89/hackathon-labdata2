...
- Fluxo de dados criado pelo Cloudformation:
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/fluxo_de_dados.png)
...
- Preencher os valores dos parâmetros solicitados de forma semelhante ao seguinte exemplo:
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/cloudformation_passo1.png)
...
- Verifique o status da evolução do cloudformation ecommerce:
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/cloudformation_passo2.png)


- Aguarde, entre 12 e 20 minutos, para o deploy fique com o status de completo (CREATE_COMPLETE):
  
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/cloudformation_passo3.png)


- Valide os recursos criados:

    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/cloudformation_passo4.png)
...
- Va para a console do Kinesis:
   ...
   ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_dashboard.png)
...
- Inicie a aplicação do Kinesis Analytics:
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_analytics_passo1.png)
    
    - Abra a aplicação e va para o botão "Go To SQL editor":
    
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_analytics_passo2.png)
    
    - Clique para ir para o SQL editor e inicie a application, clique “Yes, start application”:
    
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_analytics_passo3.png)
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_analytics_query.png)
    
    - verifique a amostra de dados no streaming:
     ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_analytics_sample.png)
     
     ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/kinesis_analytics_sample2.png)
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/s3_bucket_raw_aggregated.png)
    
    - Navegue nas pastas e verifique os arquivos:
    
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/s3_bucket_raw_files.png)
  ...
  ## Crawler do s3 para obter a definição de tabela no Glue
    ...
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/glue_crawler_passo1.png)
  
    ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/glue_crawler_passo2.png)
  ...
  ## Realize query nos dados no Amazon Athena
    ...
    - Clique em Get Started, então clique (x) para sair do tutorial:
     ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/athena_tutorial.png)
     
    - Escolha o database sessions_ecommerce:
     
     ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/athena_database.png)
    
    - Verifique as tabelas raw e aggregated:
  
     ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/athena_query_raw.png)
  ## Tarefas
...
| partition_3  | hour          |   |
 ...
 ### Tarefas 3 - Visualização:
  ...
  #### Tarefa 3.1 - Gráfico de pizza por device:
   ...
   ![alt text](https://github.com/ccaio89/hackathon-labdata2/blob/master/desafio_case_ecommerce/imagens/acessos_por_device.png)
